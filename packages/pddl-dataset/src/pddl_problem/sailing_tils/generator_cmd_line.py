"""Command-line interface for the sailing-TIL generator."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate parameterized sailing-TIL PDDL instances.")
    ...
    parser.add_argument("-problem_name", dest="problem_name", default="sailing_tils")
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = SailingTilsConfig.model_validate(
